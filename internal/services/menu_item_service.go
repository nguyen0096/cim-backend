...
type MenuItemService interface {
	...
	ListMenuItems(ctx context.Context, limit, offset int, search string, tags []string) ([]models.MenuItem, error)
}
...
func (s *menuItemService) ListMenuItems(ctx context.Context, limit, offset int, search string, tags []string) ([]models.MenuItem, error) {
	return s.menuItemRepo.List(ctx, limit, offset, search, tags)
}
