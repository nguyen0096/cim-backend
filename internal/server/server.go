...
func SetupServer(
	...
	reconciliationRequestItemRepo := repository.NewReconciliationRequestItemRepository(baseRepo)
	...
	revenueExpenses.GET("/finalize", revenueExpenseHandler.ListFinalizedDates)
