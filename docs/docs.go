...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/inventories/reconciliations": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by reconcile status (open|closed)",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.PaginationResult-dto_SubmissionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CloseReconciliationResult"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/inventories/submissions/{id}/reconciliation-items/{item_id}/review-label": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Target session readiness",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SetReconciliationItemReadinessRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.SetReconciliationItemReadinessRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "dto.SubmissionResponse": {
            ...
            "properties": {
                ...
                "review_label": {
                    "description": "ReviewLabel is set only for active reconcile submissions; aggregated on read\nfrom per-session readiness. Empty for every other submission.",
                    "allOf": [
                        {
        ...
        "models.PaginationResult-dto_SubmissionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
